...
const SATZ_GROUPS=[
    ...
    {key:'indirekt',cats:['dass','ob'],
     t:{de:'Indirekte Rede · dass / ob',
        ru:'Косвенная речь · dass / ob',
        en:'Indirect speech · dass / ob',
        tr:'Dolaylı anlatım · dass / ob',
        ar:'الكلام المنقول · dass / ob',
        fa:'گفتار غیرمستقیم · dass / ob',
        vi:'Lời tường thuật · dass / ob'}},
