 ...
 * (A1 ~30 W · A2 ~50 W · B1 ~80 W · B2 ~150 W · C1 ~230 W).
 */
(function () {
  'use strict';
  window.LETTER_TASKS = [
    /* ───────────────────────── A1 — informell, ~30 Wörter ───────────────────────── */
    {
      ...
      anrede: 'Liebe Anna,', gruss: 'Liebe Grüße, [dein Name]', minWords: 30,
    ...
    },
    {
      ...
      anrede: 'Lieber Tom,', gruss: 'Bis bald, [dein Name]', minWords: 30,
    ...
    },
    {
      ...
      anrede: 'Lieber Max,', gruss: 'Viele Grüße, [dein Name]', minWords: 30,
      hint: 'ich bin in …, das Wetter ist …, ich besuche / schwimme / esse …',
    },

    /* ───────────────────────── A2 — informell + einfach formell, ~50 Wörter ───────────────────────── */
    {
      ...
      anrede: 'Liebe Sara,', gruss: 'Ich freue mich auf dich! Liebe Grüße, [dein Name]', minWords: 50,
    ...
    },
    {
      ...
      anrede: 'Lieber Jan,', gruss: 'Liebe Grüße, [dein Name]', minWords: 50,
    ...
    },
    {
      ...
      anrede: 'Sehr geehrte Damen und Herren,', gruss: 'Mit freundlichen Grüßen, [Vor- und Nachname]', minWords: 50,
      hint: 'ich interessiere mich für …, könnten Sie mir sagen …, ich möchte …',
    },

    /* ───────────────────────── B1 — informell & formell, ~80 Wörter ───────────────────────── */
    {
      ...
      anrede: 'Liebe Lena,', gruss: 'Ich hoffe, wir sehen uns bald! Liebe Grüße, [dein Name]', minWords: 80,
    ...
    },
    {
      ...
      anrede: 'Sehr geehrter Herr Bauer,', gruss: 'Mit freundlichen Grüßen, [Vor- und Nachname]', minWords: 80,
    ...
    },
    {
      ...
      anrede: 'Sehr geehrte Damen und Herren,', gruss: 'Mit freundlichen Grüßen, [Vor- und Nachname]', minWords: 80,
      hint: 'ich schreibe Ihnen, weil …, könnten Sie mir mitteilen, ob …, über eine Antwort würde ich mich freuen',
    },

    /* ───────────────────────── B2 — meist formell, ~150 Wörter ───────────────────────── */
    {
      ...
      anrede: 'Sehr geehrte Damen und Herren,', gruss: 'Mit freundlichen Grüßen, [Vor- und Nachname]', minWords: 150,
    ...
    },
    {
      ...
      anrede: 'Sehr geehrte Frau Klein,', gruss: 'Mit freundlichen Grüßen, [Vor- und Nachname]', minWords: 150,
    ...
    },
    {
      ...
      anrede: 'Sehr geehrte Redaktion,', gruss: 'Mit freundlichen Grüßen, [Vor- und Nachname]', minWords: 150,
      hint: 'in Ihrem Artikel … wird behauptet, dass …, meiner Meinung nach …, zwar … aber …, zusammenfassend …',
    },

    /* ───────────────────────── C1 — formell & anspruchsvoll, ~230 Wörter ───────────────────────── */
    {
      ...
      anrede: 'Sehr geehrte Redaktion,', gruss: 'Mit freundlichen Grüßen, [Vor- und Nachname]', minWords: 230,
    ...
    },
    {
      ...
      anrede: 'Sehr geehrte Damen und Herren,', gruss: 'Mit freundlichen Grüßen, [Vor- und Nachname]', minWords: 230,
    ...
    },
    {
      ...
      anrede: 'Sehr geehrtes Auswahlkomitee,', gruss: 'Mit freundlichen Grüßen, [Vor- und Nachname]', minWords: 230,
